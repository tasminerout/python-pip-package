...
class TestBasicCalculationsDuplicate(unittest.TestCase):
    def test_add(self):
        print(" testing test_add in TestBasicCalculationsDuplicate ")
        self.assertEqual(TestCalculator.add(1, 2), 3)

    def test_addval(self):
        print(" testing test_addval in TestBasicCalculationsDuplicate ")
        calculator = TestCalculator(1, 2)
        self.assertEqual(calculator.addval(), 3)

    def test_addval2(self):
        print(" testing test_addval2 in TestBasicCalculationsDuplicate ")
